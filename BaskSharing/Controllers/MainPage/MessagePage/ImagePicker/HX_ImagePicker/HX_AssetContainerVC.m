...
- (void)setup
{
    ...
    flowLayout.itemSize = CGSizeMake(LYSCREEN_WIDTH, LYSCREEN_HEIGHT);
    flowLayout.minimumInteritemSpacing = 0;
    flowLayout.minimumLineSpacing = 0;
    flowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, LYSCREEN_WIDTH, LYSCREEN_HEIGHT) collectionViewLayout:flowLayout];
    collectionView.dataSource = self;
    collectionView.delegate = self;
    collectionView.pagingEnabled = YES;
    collectionView.contentSize = CGSizeMake(self.photoAy.count * (LYSCREEN_WIDTH), 0);
    [self.view addSubview:collectionView];
    _collectionView = collectionView;
    
    [collectionView registerClass:[HX_AssetContainerViewCell class] forCellWithReuseIdentifier:@"cell"];
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, LYSCREEN_HEIGHT - 45, LYSCREEN_WIDTH, 45)];
    ...
    confirmBtn.frame = CGRectMake(LYSCREEN_WIDTH - 70, 0, 60, 30);
    confirmBtn.center = CGPointMake(confirmBtn.center.x, 22.5);
    _confirmBtn = confirmBtn;
    
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 0, LYSCREEN_WIDTH, 0.5)];
    ...
    if (_ifLookPic) {
        ...
        topLb.center = CGPointMake(LYSCREEN_WIDTH / 2, topLb.center.y);
    ...
    [collectionView setContentOffset:CGPointMake(_currentIndex * LYSCREEN_WIDTH, 0) animated:NO];
}
...
{
    HX_AssetContainerViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    offSetWidth = offSetWidth +  (LYSCREEN_WIDTH * 0.5);
    
    NSInteger currentIndex = offSetWidth / LYSCREEN_WIDTH + 1;
    
    HX_AssetContainerViewCell *cell = (HX_AssetContainerViewCell *)[self.collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:currentIndex- 1 inSection:0]];
