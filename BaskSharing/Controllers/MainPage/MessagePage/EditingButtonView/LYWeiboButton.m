...
@interface LYWeiboButton ()
@property (nonatomic, copy) NSString *title;
@property (nonatomic, copy) NSString *image;


@property (nonatomic, strong) LYButton *button;
@property (nonatomic, strong) UILabel *titleLabel;
@end

@implementation LYWeiboButton

+ (LYWeiboButton *)buttonWithFrame:(CGRect)frame image:(NSString *)image title:(NSString *)title
{
    return [[LYWeiboButton alloc] initWithFrame:frame image:image title:title];
}
...
- (UIButton *)button
{
    if (!_button) {
        ...
        _button = [LYButton buttonWithType:UIButtonTypeCustom];
