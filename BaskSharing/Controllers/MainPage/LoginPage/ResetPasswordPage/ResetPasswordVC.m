    ...
    [btnRegister mas_makeConstraints:^(MASConstraintMaker *make)
     {
         ...
         make.leading.equalTo(textpassword).mas_offset(-30);
...
//                NSLog(@"%s===%@",__func__,error);
                [self showAlterControllerWithString:@"手机重置密码提示:" titleWithMessage:@"错误error"];
...
//        NSLog(@"您输入的内容有误");
        /**弹框提示*/
        [self showAlterControllerWithString:@"手机重置密码提示:" titleWithMessage:@"您输入的内容有误"];
    }
...
{
    [_textIPhone resignFirstResponder];
    [_textTesting resignFirstResponder];
