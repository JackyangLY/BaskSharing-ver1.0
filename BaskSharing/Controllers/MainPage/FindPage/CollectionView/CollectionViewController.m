...
- (UITableView *)tableView
{
    if (!_tableView)
    {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 80, LYSCREEN_HEIGHT)];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(2 + 80, 2 + 64, LYSCREEN_WIDTH - 80 - 4, LYSCREEN_HEIGHT - 64 - 4) collectionViewLayout:flowlayout];
...
{
    return CGSizeMake((LYSCREEN_WIDTH - 80 - 4 - 4) / 3,
                      (LYSCREEN_WIDTH - 80 - 4 - 4) / 3 + 30);
}
